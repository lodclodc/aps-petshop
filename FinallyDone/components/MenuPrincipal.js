...
          <View style={{ flexDirection: "row", gap: 16, alignItems: "center" }}>
                {/* CORREÇÃO: Usamos View para empilhar textos e eliminar o espaçamento indesejado de '\n' */}
                <View>
                    <Text style={globalStyles.listText}>Cliente: {item.cliente}</Text>
                    <Text style={globalStyles.listText}>Animal: {item.pet}</Text>
                    <Text style={globalStyles.listText}>Serviço: {item.servico}</Text>
                    <Text style={globalStyles.listText}>Horário: {item.hora}</Text>
                </View>
